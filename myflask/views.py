...
# call models.py, to give the top 3 matching items
    ...
    im = io.imread(os.path.join('/home/miracle/flask/myflask',save_path))
...
# 1_30 modification
    ...
    match_image_list.append(os.path.join('/static/data/Harrods', tmp))
    ...
    prod_image_list.append(os.path.join('/static/data/Harrods', tmp))
